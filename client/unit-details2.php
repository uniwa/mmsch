<div id="unit-<?php echo $_GET['mm_id']; ?>-preview"  
				...
				<div class="k-content">
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							...
							<p class="text-muted"><em>Δεν υπάρχουν Κυκλώματα</em></p>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							...
							<p class="text-muted"><em>Δεν υπάρχουν CPEs</em></p>
						</div>
					</div>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							...
							<p class="text-muted"><em>Δεν υπάρχουν UIDs</em></p>
    ...
    <div class="k-content accordion-wrapper" style="padding:10px;">
       	...
       	<div class="item-header">
       		<h5 style=""><strong data-bind="text: unitData.name"></strong></h5>
       	</div>
		...
		<div id="sidebar">
			<nav class="navbar navbar-default" role="navigation">
				...
				<ul id="info-panelbar-<?php echo $_GET['mm_id']; ?>" class="nav navbar-nav">
					...
					<li class="dropdown">
						<a id="dLabel" href="#holder-net-infos" class="dropdown-toggle" data-toggle="dropdown" ><i class="fa fa-link"></i><b class="caret"></b></a>
						...
						<table class="table borderless">
							<tbody>
								<tr>
									...
									<td class="term-value" data-bind="text: unitData.mm_id"></td>
								</tr>
								<tr>
									<td class="detail-term">Κωδικός ΥΠΕΠΘ</td>
									<td class="term-value" data-bind="text: unitData.registry_no"></td>
								</tr>
								<tr>
									<td class="detail-term">Κωδικός GLUC</td>
									<td class="term-value" data-bind="text: unitData.gluc"></td>
								</tr>
								<tr>    
									<td class="detail-term">Διεύθυνση εκπαίδευσης</td>
									<td class="term-value" data-bind="text: unitData.edu_admin"></td>
								</tr>
								<tr>
									<td class="detail-term">Φορέας Υλοποίησης</td>
									<td class="term-value" data-bind="text: unitData.implementation_entity"></td>
								</tr>
								<tr>
									<td class="detail-term">Τηλέφωνο Επικοινωνίας</td>
									<td class="term-value" data-bind="text: unitData.phone_number"></td>
								</tr>
							</tbody>
						</table>
					</div>
							...
							<table class="table borderless">
								<tbody>
									...
									<tr>
										...
										<td class="term-value" data-text="text: unitData.special_name"></td>
									</tr>
									...
									<tr>
										...
										<td class="term-value" data-bind="text: unitData.fax_number"></td>
									</tr>
									
									<tr>
										<td class="detail-term">Ηλεκτρονική Αλληλογραφία</td>
										<td class="term-value" data-bind="text: unitData.email"></td>
									</tr>
					...
					<div id="holder-net-infos" class="detail-section">
						...
						<div class="detail-section-tab">
							...
							<div class="detail-section-tab-content">
								...
								<div class="detail-section-tab-content list-item" data-bind="source: unitData" data-template="tmpl-connection-list"></div>
						...
						<div id="holder-circuits" class="detail-section-tab">
							...
							<div class="detail-section-tab-content" data-bind="source: unitData" data-template="tmpl-circuit-list"></div>
								...
								# if (circuits != null && circuits.length > 0) { #
									...
									<tr>
										<td class="term-value term-head">Κύκλωμα ${i+1}</span>
						...
						<div id="holder-cpes" class="detail-section-tab">
							...
							<div class="detail-section-tab-content" data-bind="source: unitData" data-template="tmpl-cpe-list"></div>
								...
								# } else { #
								<p class="text-muted"><em>Δεν υπάρχουν CPE</em></p>
								# } #
								</script>
						...
						<div id="holder-uids" class="detail-section-tab">
							...
							<div class="detail-section-tab-content" data-bind="source: unitData" data-template="tmpl-ldap-list"></div>
								...
								# } else { #
								<p class="text-muted"><em>Δεν υπάρχουν Ldaps</em></p>
								# } #
								</script>
		...
		wnd_create_connection = $("#wnd_create_connection_" + mm_id)
				.kendoWindow({
					...
					close: function(e) {
						...
						$.each($("#frm_create_connection_1002553").find(".k-grid"), function(idx, gridElem){
