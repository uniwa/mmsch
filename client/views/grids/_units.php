...
<script type="text/x-kendo-template" id="unit-details-template">
    ...
    <div>
    <div class="grid-details-workers"></div>
    </div>
    <div>
        ...
        var gridUnits = $("#grid-units").kendoGrid({
            dataSource: new kendo.data.DataSource({
                ...
                requestEnd: function(e) {
                    ...
                    //$("li#log-rq-units-" + this['rqc']).data('filter', $("#grid-units").data('kendoGrid').dataSource.filter().filters);

                    //$("li#log-rq-units-" + this['rqc']).on("click", function(e){
                    //$("#grid-units").data('kendoGrid').dataSource.filter($(this).data('filter'));
                    //});
                }
            }),
