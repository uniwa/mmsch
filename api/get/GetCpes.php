 ...
 * <code>
 *    curl -X GET http://mm.sch.gr/api/cpes \
 ...
 *    http.open("GET", "http://mm.sch.gr/api/cpes");
 ...
 *    header("Content-Type: text/html; charset=utf-8");
 * 
 *    $curl = curl_init("http://mm.sch.gr/api/cpes");
 * 
