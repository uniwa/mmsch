...
* **ΛΕΞΙΚΟ : Δ.Ο.Υ (Εφορία)**
 * 
 * Η συνάρτηση αυτή επιστρέφει Δ.Ο.Υ (Εφορία) σύμφωνα με τις παραμέτρους που έγινε η κλήση.
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **GET** και route_api_name = **tax_offices** :
 ...
 *  "status": 200,
 *  "message": "[GET][tax_offices]:success"
 * }
 * </code>
 *
 * ***Πίνακας Δεδομένων***
 ...
 * 
 * 
 * @param mixed $tax_office Δ.Ο.Υ (Εφορίας)
 * <br>
 ...
 * <ul>
 *    <li>integer
 *       <br>Αριθμητική : Η αναζήτηση γίνεται με τον Κωδικό ID της Δ.Ο.Υ (Εφορίας)
 *       <br>Η αναζήτηση στον Κωδικό γίνεται με τον Τύπο {@see SearchEnumTypes::Exact}
 *    </li>
 *    <li>string
 *       <br>Αλφαριθμητική : Η αναζήτηση γίνεται με το Όνομα της Δ.Ο.Υ (Εφορίας)
 ...
 *  <ul>
 *    <li>integer : <b>tax_office_id</b> : Ο Κωδικός ID της Δ.Ο.Υ (Εφορίας)</li>
 *    <li>string : <b>tax_office</b> : Το Όνομα της Δ.Ο.Υ (Εφορίας)</li>
 *  </ul>
