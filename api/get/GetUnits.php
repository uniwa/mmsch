 ...
 * <br> http://mmsch.teiath.gr/api/units
 *
 *
 ...
 * <code>
 * curl -X GET http://mmsch.teiath.gr/api/units \
 ...
 *    http.open("GET", "http://mmsch.teiath.gr/api/units");
...
//======================================================================================================================
        ...
        foreach ($rows as $row)
        {
            ...
            //    "suspended"                => $row["suspended"] ? (bool)$row["suspended"] : null,
                ...
                "addrspace_type_id"        => $row["addrspace_type_id"] ? (int)$row["addrspace_type_id"] : null,
