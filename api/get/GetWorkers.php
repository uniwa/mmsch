 ...
 * <br> http://mmsch.teiath.gr/api/workers
 *
 *
 ...
 * <code>
 *    curl -X GET http://mmsch.teiath.gr/api/workers \
 ...
 *    http.open("GET", "http://mmsch.teiath.gr/api/workers");
...
function GetWorkers(
    $worker, $registry_no, $worker_specialization,
