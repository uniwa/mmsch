...
/** 
 * <b>Λεξικό : Καταστάσεις</b>
 * 
 *
 * Η συνάρτηση αυτή επιστρέφει όλους τις Καταστάσεις σύμφωνα με τις παραμέτρους που έγινε η κλήση
 *
 * 
 * Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο GET :
 * <br> http://mmsch.teiath.gr/api/states 
 *
 *
 * Τα αποτελέσματα είναι ταξινομημένα ως προς το Όνομα της Κατάστασης
 ...
 * <code>
 *    curl -X GET http://mmsch.teiath.gr/api/states \
 ...
 *    http.open("GET", "http://mmsch.teiath.gr/api/states");
 ...
 * header("Content-Type: text/html; charset=utf-8");
 * 
 * $curl = curl_init("http://mmsch.teiath.gr/api/states");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mmsch.teiath.gr/api/states',
 *        dataType: "json",
 ...
 * <br>Το Όνομα ή ο Κωδικός της Κατάστασης
 ...
 * <ul>
 *    <li>integer
 *       <br>Αριθμητική : Η αναζήτηση γίνεται με τον κωδικό της Κατάστασης
 *       <br>Η αναζήτηση στον Κωδικό γίνεται με τον Τύπο {@see SearchEnumTypes::Exact}
 *    </li>
 *    <li>string
 *       <br>Αλφαριθμητική : Η αναζήτηση γίνεται με το Όνομα της Κατάστασης
 ...
 *       θα αναζητηθεί η τιμή της παραμέτρου στο Όνομα της Κατάστασης
 *       <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα της Κατάστασης γίνεται με τον Tύπο {@see SearchEnumTypes::ContainAll}
 *    </li>
 ...
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η ταξινόμηση γίνεται με το Όνομα της Κατάστασης
 ...
 * <br>Ο Τύπος Αναζήτησης με τον οποίο γίνεται η αναζήτηση στο Όνομα (<a href="#$state">$state</a>) της Κατάστασης
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα γίνεται με τον Τύπο {@see SearchEnumTypes::ContainAll}
 * <br>Αν το Όνομα έχει Αριθμητική Τιμή τότε η αναζήτηση γίνεται με τον Κωδικό της Κατάστασης με Τύπο {@see SearchEnumTypes::Exact}
 * <br>Λίστα Τύπων Αναζήτησης : {@see SearchEnumTypes}
 * <br>Η τιμή της παραμέτρου μπορεί να είναι : string
 * <ul>
 *    <li>string
 ...
 * <ul>
 *   <li>integer : <b>state_id</b> : Ο Κωδικός της Κατάστασης</li>
 *   <li>string : <b>state</b> : Το Όνομα της Κατάστασης</li>
 * </ul>
 *
 * 
 * 
 ...
 * <br>Η Κατάσταση πρέπει να είναι αριθμητική ή αλφαριθμητική
 *
