...
/**
* **ΛΕΞΙΚΟ : Λειτουργικές Καταστάσεις**
 * 
 * Η συνάρτηση αυτή επιστρέφει Λειτουργικές Καταστάσεις σύμφωνα με τις παραμέτρους που έγινε η κλήση.
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **GET** και route_api_name = **states** :
 ...
 *  <ul>
 *    <li>integer : <b>state_id</b> : Ο Κωδικός ID της Λειτουργικής Καταστάσης</li>
 *    <li>string : <b>state</b> : Το Όνομα της Λειτουργικής Καταστάσης</li>
 *  </ul>
