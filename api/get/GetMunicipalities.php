 ...
 * <br> http://mmsch.teiath.gr/api/municipalities
 *
 *
 ...
 * <code>
 *    curl -X GET http://mmsch.teiath.gr/api/ \
 ...
 *    http.open("GET", "http://mmsch.teiath.gr/api/municipalities");
 ...
 * 
 * $curl = curl_init("http://mmsch.teiath.gr/api/municipalities");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mmsch.teiath.gr/api/municipalities',
 *        dataType: "json",
