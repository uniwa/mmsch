 ...
 * <code>
 *    curl -X GET https://mm.sch.gr/api/ \
 ...
 *    http.open("GET", "https://mm.sch.gr/api/municipalities");
 ...
 * 
 * $curl = curl_init("https://mm.sch.gr/api/municipalities");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'https://mm.sch.gr/api/municipalities',
 *        dataType: "json",
