 ...
 * **ΛΕΞΙΚΟ : Κατηγορίες**
 * 
 * Η συνάρτηση αυτή επιστρέφει Κατηγορίες σύμφωνα με τις παραμέτρους που έγινε η κλήση.
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **GET** και route_api_name = **categories** :
 ...
 *  <ul>
 *    <li>integer : <b>category_id</b> : Ο Κωδικός ID της Κατηγορίας</li>
