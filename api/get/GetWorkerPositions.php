 ...
 * <code>
 *    curl -X GET https://mm.sch.gr/api/worker_positions \
 ...
 *    http.open("GET", "https://mm.sch.gr/api/worker_positions");
 ...
 * header("Content-Type: text/html; charset=utf-8");
 * 
 * $curl = curl_init("https://mm.sch.gr/api/worker_positions");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'https://mm.sch.gr/api/worker_positions',
 *        dataType: "json",
