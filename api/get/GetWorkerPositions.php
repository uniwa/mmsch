...
/** 
 * <b>Λεξικό : Θέσεις Εργασίας</b>
 * 
 * 
 *
 * Η συνάρτηση αυτή επιστρέφει όλες τις Θέσεις Εργασίας Εργαζομένων σύμφωνα με τις παραμέτρους που έγινε η κλήση
 *
 *
 * Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο GET :
 * <br> http://mmsch.teiath.gr/api/worker_positions
 *
 *
 * Τα αποτελέσματα είναι ταξινομημένα ως προς το Όνομα της Θέσης Εργασίας
 ...
 * <code>
 *    curl -X GET http://mmsch.teiath.gr/api/worker_positions \
 ...
 *    http.open("GET", "http://mmsch.teiath.gr/api/worker_positions");
 ...
 * header("Content-Type: text/html; charset=utf-8");
 * 
 * $curl = curl_init("http://mmsch.teiath.gr/api/worker_positions");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mmsch.teiath.gr/api/worker_positions',
 *        dataType: "json",
 ...
 *  
 * 
 * @param mixed $worker_position Θέση Εργασίας
 * <br>Το Όνομα ή ο Κωδικός της Θέσης Εργασίας
 ...
 * <ul>
 *    <li>integer
 *       <br>Αριθμητική : Η αναζήτηση γίνεται με τον Κωδικό της Θέσης Εργασίας
 *       <br>Η αναζήτηση στον Κωδικό γίνεται με τον Τύπο {@see SearchEnumTypes::Exact}
 *    </li>
 *    <li>string
 *       <br>Αλφαριθμητική : Η αναζήτηση γίνεται με το Όνομα της Θέσης Εργασίας
 ...
 *       θα αναζητηθεί η τιμή της παραμέτρου στο Όνομα της Θέσης Εργασίας
 *       <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα της Θέσης Εργασίας γίνεται με τον Tύπο {@see SearchEnumTypes::ContainAll}
 *    </li>
 ...
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η ταξινόμηση γίνεται με το Όνομα της Θέσης Εργασίας
 ...
 * <br>Ο Τύπος Αναζήτησης με τον οποίο γίνεται η αναζήτηση στο Όνομα (<a href="#$worker_position">$worker_position</a>) της Θέσης Εργασίας
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα γίνεται με τον Τύπο {@see SearchEnumTypes::ContainAll}
 * <br>Αν το Όνομα έχει Αριθμητική Τιμή τότε η αναζήτηση γίνεται με τον Κωδικό της Θέσης Εργασίας με Τύπο {@see SearchEnumTypes::Exact}
 * <br>Λίστα Τύπων Αναζήτησης : {@see SearchEnumTypes}
 * <br>Η τιμή της παραμέτρου μπορεί να είναι : string
 * <ul>
 *    <li>string
 ...
 * <ul>
 *   <li>integer : <b>worker_position_id</b> : Ο Κωδικός της Θέσης Εργασίας</li>
 *   <li>string : <b>worker_position</b> : Το Όνομα της Θέσης Εργασίας</li>
 * </ul>
 *
 * 
 * 
...
//======================================================================================================================
        ...
        {
            $result["data"][] = array(
                "worker_position_id" => (int)$row["worker_position_id"],
