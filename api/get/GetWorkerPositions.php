...
/**
* **ΛΕΞΙΚΟ : Θέσεις Εργασίας**
 * 
 * Η συνάρτηση αυτή επιστρέφει Θέσεις Εργασίας σύμφωνα με τις παραμέτρους που έγινε η κλήση.
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **GET** και route_api_name = **worker_positions** :
 ...
 *  "status": 200,
 *  "message": "[GET][worker_positions]:success"
 * }
 * </code>
 *
 * ***Πίνακας Δεδομένων***
 ...
 * <ul>
 *    <li>integer
 *       <br>Αριθμητική : Η αναζήτηση γίνεται με τον Κωδικό ID της Θέσης Εργασίας
 ...
 *  <ul>
 *    <li>integer : <b>worker_position_id</b> : Ο Κωδικός ID της Θέσης Εργασίας</li>
