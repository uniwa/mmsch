 ...
 *   "selection" ->  1 : null region_edu_admin (χωρίς περιφέρεια)
 ...
 *  [total] : το σύνολο το αποτελεσμάτων
 *  [data] : επιστρέφεται στην περίπτωση της επιλογής παραμέτρου $all_data και περιέχει arrays με name,mm_id,registry_no
 *  [count] : επιστρέφεται στην περίπτωση της επιλογής παραμέτρου $all_data και αποτελεί το σύνολο το αποτελεσμάτων (πρέπει να έιναι ίδιο με την τιμή του [total]) 
 * 
 */
