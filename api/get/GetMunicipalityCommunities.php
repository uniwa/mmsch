...
/**
 * **ΛΕΞΙΚΟ : Δημοτικές Ενότητες**
 * 
 * Η συνάρτηση αυτή επιστρέφει Δημοτικές Ενότητες σύμφωνα με τις παραμέτρους που έγινε η κλήση.
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **GET** και route_api_name = **municipality_communities** :
 ...
 * {
 *  "data": [{}],
 *  "controller": "GetMunicipalityCommunities",
 ...
 *  "status": 200,
 *  "message": "[GET][municipality_communities]:success"
 * }
 * </code>
 *
 * ***Πίνακας Δεδομένων***
 ...
 * 
 *
 * @param string $municipality_community_id ID Δημοτικής Ενότητας
 * <br>
 * <br>Το ID Δημοτικής Ενότητας
 * <br>Η τιμή της παραμέτρου μπορεί να είναι : integer|array[integer]
 * <ul>
 *    <li>integer
 *       <br>Αριθμητική : Η αναζήτηση γίνεται με ID Δημοτικής Ενότητας
 *    </li>
 *    <li>array[integer]
 ...
 * </ul>
 * 
 * @param string $name Όνομα Δημοτικής Ενότητας
 * <br>
 ...
 *  <ul>
 *    <li>integer : <b>municipality_community_id</b> : Ο Κωδικός ID της Δημοτικής Ενότητας</li>
 *    <li>string : <b>municipality_community</b> : Το Όνομα της Δημοτικής Ενότητας</li>
 *    <li>integer : <b>myschoolMunicipalityCommunityId</b> : Ο Κωδικός ID της Δημοτικής Ενότητας του Myschool</li>
 *    <li>integer : <b>municipality_id</b> : Ο Κωδικός ID του Δήμου της Δημοτικής Ενότητας</li>
 *    <li>string : <b>municipality_name</b> : Το Όνομα του Δήμου της Δημοτικής Ενότητας</li>
 *  </ul>
