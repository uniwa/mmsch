 ...
 * <br> http://mmsch.teiath.gr/api/school_committees
 *
 *
 ...
 * <code>
 *    curl -X GET http://mmsch.teiath.gr/api/school_committees \
 ...
 *    http.open("GET", "http://mmsch.teiath.gr/api/school_committees");
 ...
 *    );
 * 
 *    $curl = curl_init("http://mmsch.teiath.gr/api/school_committees");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mmsch.teiath.gr/api/school_committees',
 *        dataType: "json",
 *        data: {
 *          "education_level" : "ΔΕΥΤΕΡΟΒΑΘΜΙΑ"
 *        },
