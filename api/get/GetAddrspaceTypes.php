...
/**
 * <b>Λεξικό : Τύποι Διευθυνσιοδότησης</b>
 *
 *
 * Η συνάρτηση αυτή επιστρέφει όλους τους Τύπους Διευθυνσιοδότησης σύμφωνα με τις παραμέτρους που έγινε η κλήση
 *
 *
 * Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο GET :
 * <br> http://mmsch.teiath.gr/api/addrspace_types
 *
 *
 ...
 * <code>
 *    curl -X GET http://mmsch.teiath.gr/api/addrspace_types \
 ...
 *    http.open("GET", "http://mmsch.teiath.gr/api/addrspace_types");
 ...
 *    header("Content-Type: text/html; charset=utf-8");
 * 
 *    $curl = curl_init("http://mmsch.teiath.gr/api/addrspace_types");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mmsch.teiath.gr/api/addrspace_types',
 *        dataType: "json",
 ...
 * {"data":[
 *  	{
 *  		"addrspace_type_id": 10,
 *  		"addrspace_type": "ADSL_R"
 *  	},
 *  	{
 *  		"addrspace_type_id": 11,
 *  		"addrspace_type": "ADSL_R_auth_d"
 *  	},
 *  	{
 *  		"addrspace_type_id": 12,
 *  		"addrspace_type": "ADSL_R_auth_f"
 *  	},
 *  	{
 *  		"addrspace_type_id": 13,
 *  		"addrspace_type": "ADSL_R_auth_t"
 *  	},
 *  	{
 *  		"addrspace_type_id": 14,
 *  		"addrspace_type": "ADSL_R_H"
 *  	},
 *  	{
 *  		"addrspace_type_id": 15,
 *  		"addrspace_type": "ADSL_R_plinet"
 *  	},
 *  	{
 *  		"addrspace_type_id": 16,
 *  		"addrspace_type": "ADSL_R_UOTH"
 *  	}
 * ]}
 * </code>
 * <br>
 ...
 *  
 *
 * @param mixed $addrspace_type Τύπος Διευθυνσιοδότησης
 * <br>Ο Κωδικός και το λεκτικό του Τύπου Διευθυνσιοδότησης
 ...
 * <ul>
 *    <li>integer
 *       <br>Αριθμητική : Η αναζήτηση γίνεται με τον κωδικό του Τύπου Διευθυνσιοδότησης
 *       <br>Η αναζήτηση στον Κωδικό γίνεται με τον Τύπο {@see SearchEnumTypes::Exact}
 *    </li>
 *    <li>string
 *       <br>Αλφαριθμητική : Η αναζήτηση γίνεται με το Όνομα του Τύπου Διευθυνσιοδότησης
 ...
 *       θα αναζητηθεί η τιμή της παραμέτρου στο Όνομα του Τύπου Διευθυνσιοδότησης
 *       <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα του Τύπου Διευθυνσιοδότησης γίνεται με τον Tύπο {@see SearchEnumTypes::ContainAll}
 *    </li>
 ...
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η ταξινόμηση γίνεται με το Όνομα του Τύπου Διευθυνσιοδότησης
 ...
 * <br>Ο Τύπος Αναζήτησης με τον οποίο γίνεται η αναζήτηση στο Όνομα (<a href="#$addrspace_type">$addrspace_type</a>) του Τύπου Διευθυνσιοδότησης
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα γίνεται με τον Τύπο {@see SearchEnumTypes::ContainAll}
 * <br>Αν το Όνομα έχει Αριθμητική Τιμή τότε η αναζήτηση γίνεται με τον Κωδικό του Τύπου Addrspace με Τύπο {@see SearchEnumTypes::Exact}
 * <br>Λίστα Τύπων Αναζήτησης : {@see SearchEnumTypes}
 * <br>Η τιμή της παραμέτρου μπορεί να είναι : string
 * <ul>
 *    <li>string
 ...
 * <ul>
 *   <li>integer : <b>addrspace_type_id</b> : Ο Κωδικός του Τύπου Διευθυνσιοδότησης</li>
 *   <li>string : <b>addrspace_type</b> : Το Όνομα του Τύπου Διευθυνσιοδότησης</li>
 * </ul>
 *
 * 
 * 
 ...
 *
 * @throws InvalidAddrspaceTypeType {@see ExceptionMessages::InvalidAddrspaceTypeType}
 * <br>{@see ExceptionCodes::InvalidAddrspaceTypeType}
 * <br>Ο Τύπος Διευθυνσιοδότησης πρέπει να είναι αριθμητικός ή αλφαριθμητικός
 *
...
//======================================================================================================================
        ...
        if ( Validator::Exists('addrspace_type', $params) )
        {
            $table_name = "addrspace_types";
            $table_column_id = "addrspace_type_id";
            $table_column_name = "name";

            $param = Validator::toArray($addrspace_type);
            ...
            foreach ($param as $values)
            {
                ...
                else if ( Validator::isValue($values) )
                {
                    ...
                    throw new Exception(ExceptionMessages::InvalidAddrspaceTypeType." : ".$values, ExceptionCodes::InvalidAddrspaceTypeType);
...
//==============================================================================
        ...
        $sqlSelect = "SELECT
                        addrspace_types.addrspace_type_id,
                        addrspace_types.name as addrspace_type
                     ";

        $sqlFrom   = "FROM addrspace_types";
        ...
        {
            $result["data"][] = array(
                "addrspace_type_id" => Validator::toIntVal($row["addrspace_type_id"]),
                "addrspace_type"    => $row["addrspace_type"]
            );
        }
