...
/** 
 * <b>Λεξικό : Μάσκες Δικτύου</b>
 *
 * 
 *
 * Η συνάρτηση αυτή επιστρέφει όλες τις Μάσκες Δικτύου σύμφωνα με τις παραμέτρους που έγινε η κλήση
 *
 *
 ...
 *
 *
 * Τα αποτελέσματα είναι ταξινομημένα ως προς το Όνομα της Μάσκας Δικτύου
 ...
 * <code>
 *    curl -X GET http://mmsch.teiath.gr/api/ip_masks \
 ...
 *    http.open("GET", "http://mmsch.teiath.gr/api/ip_masks");
 ...
 *    header("Content-Type: text/html; charset=utf-8");
 * 
 *    $curl = curl_init("http://mmsch.teiath.gr/api/ip_masks");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mmsch.teiath.gr/api/ip_masks',
 *        dataType: "json",
 ...
 *  
 * 
 * @param mixed $ip_mask Μάσκα Δικτύου
 * <br>Το Όνομα ή ο Κωδικός της Μάσκας Δικτύου
 ...
 * <ul>
 *    <li>integer
 *       <br>Αριθμητική : Η αναζήτηση γίνεται με τον κωδικό της Μάσκας Δικτύου
 *       <br>Η αναζήτηση στον Κωδικό γίνεται με τον Τύπο {@see SearchEnumTypes::Exact}
 *    </li>
 *    <li>string
 *       <br>Αλφαριθμητική : Η αναζήτηση γίνεται με το Όνομα της Μάσκας Δικτύου
 ...
 *       θα αναζητηθεί η τιμή της παραμέτρου στο Όνομα της Μάσκας Δικτύου
 *       <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα της Μάσκας Δικτύου γίνεται με τον Tύπο {@see SearchEnumTypes::ContainAll}
 *    </li>
 ...
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η ταξινόμηση γίνεται με το Όνομα της Μάσκας Δικτύου
 ...
 * <br>Ο Τύπος Αναζήτησης με τον οποίο γίνεται η αναζήτηση στο Όνομα (<a href="#$ip_mask">$ip_mask</a>) της Μάσκας Δικτύου
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα γίνεται με τον Τύπο {@see SearchEnumTypes::ContainAll}
 * <br>Αν το Όνομα έχει Αριθμητική Τιμή τότε η αναζήτηση γίνεται με τον Κωδικό της Μάσκας Δικτύου με Τύπο {@see SearchEnumTypes::Exact}
 * <br>Λίστα Τύπων Αναζήτησης : {@see SearchEnumTypes}
 * <br>Η τιμή της παραμέτρου μπορεί να είναι : string
 * <ul>
 *    <li>string
 ...
 * <ul>
 *   <li>integer : <b>ip_mask_id</b> : Ο Κωδικός της Μάσκας Δικτύου</li>
 *   <li>string : <b>ip_mask</b> : Το Όνομα της Μάσκας Δικτύου</li>
 * </ul>
 *
 * 
 * 
 ...
 *
 * @throws InvalidIpMaskType {@see ExceptionMessages::InvalidIpMaskType}
 * <br>{@see ExceptionCodes::InvalidIpMaskType}
 * <br>Η Μάσκα Δικτύου πρέπει να είναι αριθμητική ή αλφαριθμητική
 *
...
//======================================================================================================================
        ...
        if ( Validator::Exists('ip_mask', $params) )
        {
            $table_name = "ip_masks";
            $table_column_id = "ip_mask_id";
            $table_column_name = "name";

            $param = Validator::toArray($ip_mask);
            ...
            foreach ($param as $values)
            {
                ...
                else if ( Validator::isValue($values) )
                {
                    ...
                    throw new Exception(ExceptionMessages::InvalidIpMaskType." : ".$values, ExceptionCodes::InvalidIpMaskType);
...
//======================================================================================================================
        ...
        $sqlSelect = "SELECT
                        ip_masks.ip_mask_id,
                        ip_masks.name as ip_mask
                     ";

        $sqlFrom   = "FROM ip_masks";
