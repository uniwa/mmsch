...
/**
 * <b>Λεξικό : Πρωτογενείς Πηγές Μονάδων</b>
 *
 *
 * Η συνάρτηση αυτή επιστρέφει όλες τις Πρωτογενείς Πηγές Μονάδων σύμφωνα με τις παραμέτρους που έγινε η κλήση
 *
 *
 ...
 * <code>
 *    curl -X GET https://mm.sch.gr/api/sources \
 ...
 *    http.open("GET", "https://mm.sch.gr/api/sources");
 ...
 *    );
 *
 *    $curl = curl_init("https://mm.sch.gr/api/sources");
 *
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'https://mm.sch.gr/api/sources',
 *        dataType: "json",
 *        data: {
 *        },
 ...
 *
 *
 * @param mixed $source Πρωτογενής Πηγή Μονάδων
 * <br>Το Όνομα ή ο Κωδικός της Πρωτογενής Πηγής Μονάδων
 ...
 * <ul>
 *    <li>integer
 *       <br>Αριθμητική : Η αναζήτηση γίνεται με τον κωδικό της Πρωτογενής Πηγής
 ...
 *       θα αναζητηθεί η τιμή της παραμέτρου στο Όνομα της Πρωτογενής Πηγής Μονάδων
 *       <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα της Πρωτογενής Πηγής γίνεται με τον Tύπο {@see SearchEnumTypes::ContainAll}
 *    </li>
 ...
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η ταξινόμηση γίνεται με το Όνομα της Πρωτογενής Πηγής
 ...
 * <br>Ο Τύπος Αναζήτησης με τον οποίο γίνεται η αναζήτηση στο Όνομα (<a href="#$source">$source</a>) της Πρωτογενής Πηγής
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα γίνεται με τον Τύπο {@see SearchEnumTypes::ContainAll}
 * <br>Αν το Όνομα έχει Αριθμητική Τιμή τότε η αναζήτηση γίνεται με τον Κωδικό της Πρωτογενής Πηγής με Τύπο {@see SearchEnumTypes::Exact}
 * <br>Λίστα Τύπων Αναζήτησης : {@see SearchEnumTypes}
 * <br>Η τιμή της παραμέτρου μπορεί να είναι : string
 * <ul>
 *    <li>string
 ...
 * <ul>
 *   <li>integer : <b>source_id</b> : Ο Κωδικός της Πρωτογενής Πηγής Μονάδων</li>
 *   <li>string : <b>source</b> : Το Όνομα της Πρωτογενής Πηγής Μονάδων</li>
 * </ul>
 *
 *
 *
...
function GetSources( $source, $visible,
...
//$source=======================================================================
        if (Validator::Exists('source', $params)){
                CRUDUtils::setFilter($qb, $source, "s", "sourceId", "name", "id,value", ExceptionMessages::InvalidSourceType, ExceptionCodes::InvalidSourceType);
        }
        
//$visible======================================================================
        if (Validator::Exists('visible', $params)){
                CRUDUtils::setFilter($qb, $visible, "s", "visible", "visible", "null,value", ExceptionMessages::InvalidSourceVisibleType, ExceptionCodes::InvalidSourceVisibleType);
        }
