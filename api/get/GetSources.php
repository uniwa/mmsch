...
/**
* **ΛΕΞΙΚΟ : Πρωτογενής Πηγές Μονάδων**
 * 
 * Η συνάρτηση αυτή επιστρέφει Πρωτογενής Πηγές Μονάδων σύμφωνα με τις παραμέτρους που έγινε η κλήση.
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **GET** και route_api_name = **sources** :
 ...
 * <br>
 * <br>Το Όνομα ή ο Κωδικός ID της Πρωτογενής Πηγής Μονάδων
 * <br>Η τιμή της παραμέτρου μπορεί να είναι : mixed{integer|string|array[integer|string]}
 * <ul>
 *    <li>integer
 *       <br>Αριθμητική : Η αναζήτηση γίνεται με τον Κωδικό ID της Πρωτογενής Πηγής Μονάδων
 *       <br>Η αναζήτηση στον Κωδικό γίνεται με τον Τύπο {@see SearchEnumTypes::Exact}
 *    </li>
 *    <li>string
 *       <br>Αλφαριθμητική : Η αναζήτηση γίνεται με το Όνομα της Πρωτογενής Πηγής Μονάδων
 ...
 *  <ul>
 *    <li>integer : <b>source_id</b> : Ο Κωδικός ID της Πρωτογενής Πηγής Μονάδων</li>
 *    <li>string : <b>source</b> : Το Όνομα της Πρωτογενής Πηγής Μονάδων</li>
 *    <li>string : <b>visible</b> : Η εμφάνιση του Ονόματος της Πρωτογενής Πηγής Μονάδων</li>
 *  </ul>
