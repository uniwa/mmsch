 ...
 * <br> http://mmsch.teiath.gr/api/transfer_areas
 *
 *
 ...
 * <code>
 *    curl -X GET http://mmsch.teiath.gr/api/transfer_areas \
 ...
 * 
 * $curl = curl_init("http://mmsch.teiath.gr/api/transfer_areas");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mmsch.teiath.gr/api/transfer_areas',
 *        dataType: "json",
