...
/** 
 * <b>Λεξικό : Ειδικότητες Εργαζομένων</b>
 * 
 * 
 * 
 * Η συνάρτηση αυτή επιστρέφει όλες οι Ειδικότητες Εργαζομένων σύμφωνα με τις παραμέτρους που έγινε η κλήση
 *
 *
 ...
 *
 *
 * Τα αποτελέσματα είναι ταξινομημένα ως προς το Όνομα της Ειδικότητας Εργαζομένου
 ...
 * <code>
 *    curl -X GET https://mm.sch.gr/api/worker_specializations \
 ...
 *    http.open("POST", "https://mm.sch.gr/api/worker_specializations");
 ...
 * header("Content-Type: text/html; charset=utf-8");
 * 
 * $curl = curl_init("https://mm.sch.gr/api/worker_specializations");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'https://mm.sch.gr/api/worker_specializations',
 *        dataType: "json",
 ...
 * {"data":[
 *		{
 *			"worker_specialization_id": 1,
 *			"worker_specialization": "Π.Ε. 19"
 *		},
 *		{
 *			"worker_specialization_id": 2,
 ...
 *  
 * 
 * @param mixed $worker_specialization Ειδικότητας Εργαζομένου
 * <br>Το Όνομα ή ο Κωδικός της Ειδικότητας Εργαζομένου
 ...
 * <ul>
 *    <li>integer
 *       <br>Αριθμητική : Η αναζήτηση γίνεται με τον Κωδικό της Ειδικότητας Εργαζομένου
 *       <br>Η αναζήτηση στον Κωδικό γίνεται με τον Τύπο {@see SearchEnumTypes::Exact}
 *    </li>
 *    <li>string
 *       <br>Αλφαριθμητική : Η αναζήτηση γίνεται με το Όνομα της Ειδικότητας Εργαζομένου
 ...
 *       θα αναζητηθεί η τιμή της παραμέτρου στο Όνομα της Ειδικότητας Εργαζομένου
 *       <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα της Ειδικότητας Εργαζομένου γίνεται με τον Tύπο {@see SearchEnumTypes::ContainAll}
 *    </li>
 ...
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η ταξινόμηση γίνεται με το Όνομα της Ειδικότητας Εργαζομένου
 ...
 * <br>Ο Τύπος Αναζήτησης με τον οποίο γίνεται η αναζήτηση στο Όνομα (<a href="#$worker_specialization">$worker_specialization</a>) της Ειδικότητας Εργαζομένου
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα γίνεται με τον Τύπο {@see SearchEnumTypes::ContainAll}
 * <br>Αν το Όνομα έχει Αριθμητική Τιμή τότε η αναζήτηση γίνεται με τον Κωδικό της Ειδικότητας Εργαζομένου με Τύπο {@see SearchEnumTypes::Exact}
 * <br>Λίστα Τύπων Αναζήτησης : {@see SearchEnumTypes}
 * <br>Η τιμή της παραμέτρου μπορεί να είναι : string
 * <ul>
 *    <li>string
 ...
 * <ul>
 *   <li>integer : <b>worker_specialization_id</b> : Ο Κωδικός της Ειδικότητας Εργαζομένου</li>
 *   <li>string : <b>worker_specialization</b> : Το Όνομα της Ειδικότητας Εργαζομένου</li>
 * </ul>
 *
 *  
 * 
...
function GetWorkerSpecializations( $worker_specialization,
...
//$worker_specialization========================================================
        if (Validator::Exists('worker_specialization', $params)){
             CRUDUtils::setFilter($qb, $worker_specialization, "ws", "workerSpecializationId", "name", "id,value", ExceptionMessages::InvalidWorkerSpecializationType, ExceptionCodes::InvalidWorkerSpecializationType);
        } 
...
//data results==================================================================       
        ...
        foreach ($results as $row)
        {
            ...
            $result["data"][] = array(
                                        "worker_specialization_id"        => $row->getWorkerSpecializationId(),
                                        "worker_specialization"           => $row->getName()
                                     );
            $count++;
        }
        $result["count"] = $count;
