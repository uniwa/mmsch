 ...
 * <br> http://mm.sch.gr/api/worker_specializations
 *
 *
 ...
 * <code>
 *    curl -X GET http://mm.sch.gr/api/worker_specializations \
 ...
 *    http.open("POST", "http://mm.sch.gr/api/worker_specializations");
 ...
 * header("Content-Type: text/html; charset=utf-8");
 * 
 * $curl = curl_init("http://mm.sch.gr/api/worker_specializations");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mm.sch.gr/api/worker_specializations',
 *        dataType: "json",
