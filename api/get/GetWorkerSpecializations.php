 ...
 * <br> http://mmsch.teiath.gr/api/worker_specializations
 *
 *
 ...
 * <code>
 *    curl -X GET http://mmsch.teiath.gr/api/worker_specializations \
 ...
 *    http.open("POST", "http://mmsch.teiath.gr/api/worker_specializations");
 ...
 * header("Content-Type: text/html; charset=utf-8");
 * 
 * $curl = curl_init("http://mmsch.teiath.gr/api/worker_specializations");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mmsch.teiath.gr/api/worker_specializations',
 *        dataType: "json",
...
//======================================================================================================================
        ...
        $sqlFrom   = "FROM worker_specializations";
