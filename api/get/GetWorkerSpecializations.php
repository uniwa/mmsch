...
/**
* **ΛΕΞΙΚΟ : Ειδικότητες Εργαζομένων**
 * 
 * Η συνάρτηση αυτή επιστρέφει Ειδικότητες Εργαζομένων σύμφωνα με τις παραμέτρους που έγινε η κλήση.
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **GET** και route_api_name = **worker_specializations** :
 ...
 * {
 *  "data": [{}],
 *  "controller": "GetWorkerSpecializations",
 ...
 *  "status": 200,
 *  "message": "[GET][worker_specializations]:success"
 * }
 * </code>
 *
 * ***Πίνακας Δεδομένων***
 ...
 * 
 * 
 * @param mixed $worker_specialization Ειδικότητα Εργαζόμενου
 * <br>
 ...
 * <ul>
 *    <li>integer
 *       <br>Αριθμητική : Η αναζήτηση γίνεται με τον Κωδικό ID της Ειδικότητας Εργαζόμενου
 *       <br>Η αναζήτηση στον Κωδικό γίνεται με τον Τύπο {@see SearchEnumTypes::Exact}
 *    </li>
 *    <li>string
 *       <br>Αλφαριθμητική : Η αναζήτηση γίνεται με το Όνομα της Ειδικότητας Εργαζόμενου
 ...
 *  <ul>
 *    <li>integer : <b>worker_specialization_id</b> : Ο Κωδικός ID της Ειδικότητας Εργαζόμενου</li>
 *    <li>string : <b>worker_specialization</b> : Το Όνομα της Ειδικότητας Εργαζόμενου</li>
 *  </ul>
