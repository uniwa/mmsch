...
/**
* **ΛΕΞΙΚΟ : Σχολικοί Προσανατολισμοί**
 * 
 * Η συνάρτηση αυτή επιστρέφει Σχολικούς Προσανατολισμούς σύμφωνα με τις παραμέτρους που έγινε η κλήση.
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **GET** και route_api_name = **orientation_types** :
 ...
 * {
 *  "data": [{}],
 *  "controller": "GetOrientationTypes",
 ...
 *  "status": 200,
 *  "message": "[GET][orientation_types]:success"
 * }
 * </code>
 *
 * ***Πίνακας Δεδομένων***
 ...
 * 
 * 
 * @param mixed $orientation_type Σχολικός Προσανατολισμός
 * <br>
 * <br>Το Όνομα ή ο Κωδικός ID του Σχολικού Προσανατολισμού
 * <br>Η τιμή της παραμέτρου μπορεί να είναι : mixed{integer|string|array[integer|string]}
 * <ul>
 *    <li>integer
 *       <br>Αριθμητική : Η αναζήτηση γίνεται με τον Κωδικό ID του Σχολικού Προσανατολισμού
 ...
 *  <ul>
 *    <li>integer : <b>orientation_type_id</b> : Ο Κωδικός ID του Σχολικού Προσανατολισμού</li>
...
function GetOrientationTypes( $orientation_type, $category,
...
//$orientation_type=============================================================
        if (Validator::Exists('orientation_type', $params)){
            CRUDUtils::setFilter($qb, $orientation_type, "os", "orientationTypeId", "name", "id,value", ExceptionMessages::InvalidOrientationTypeType, ExceptionCodes::InvalidOrientationTypeType);
        }
...
//execution=====================================================================
        $qb->select('ot');
        $qb->from('OrientationTypes','ot');
        $qb->leftjoin('ot.category','c');
...
//data results==================================================================       
        ...
        foreach ($results->getQuery()->getResult() as $row)
        {
            ...
            $result["data"][] = array(
                                        "orientation_type_id" => $row->getOrientationTypeId(),
                                        "orientation_type"    => $row->getName(),
