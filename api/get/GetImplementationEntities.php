...
/**
* **ΛΕΞΙΚΟ : Φορείς Υλοποίησης**
 * 
 * Η συνάρτηση αυτή επιστρέφει Φορείς Υλοποίησης σύμφωνα με τις παραμέτρους που έγινε η κλήση.
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **GET** και route_api_name = **implementation_entities** :
 ...
 * {
 *  "data": [{}],
 *  "controller": "GetImplementationEntities",
 ...
 *  "status": 200,
 *  "message": "[GET][implementation_entities]:success"
 * }
 * </code>
 *
 * ***Πίνακας Δεδομένων***
 ...
 *  <ul>
 *   <li>integer : <b>implementation_entity_id</b> : Ο Κωδικός ID του Φορέα Υλοποίησης</li>
 ...
 *   <li>integer : <b>postal_code</b> : Ο Ταχυδρομικός Κώδικας του Φορέα Υλοποίησης</li>
 *   <li>string : <b>email</b> : Η Ηλεκτρονική Αλληλογραφία του Φορέα Υλοποίησης</li>
 *   <li>integer : <b>phone_number</b> : Ο Τηλεφωνικός Αριθμός του Φορέα Υλοποίησης</li>
