...
function GetImplementationEntities(
...
//======================================================================================================================
        ...
        $sqlSelect = "SELECT
                        ...
                        implementation_entities.street_address,
                        implementation_entities.postal_code,
                        implementation_entities.email,
                        implementation_entities.phone_number,
                        implementation_entities.domain,
                        implementation_entities.url
                     ";

        $sqlFrom   = "FROM implementation_entities";
