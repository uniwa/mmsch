...
/**
 * <b>Λεξικό : Ωράρια Λειτουργίας</b>
 * 
 * 
 * 
 *  Η συνάρτηση αυτή επιστρέφει όλα τα Ωράρια Λειτουργίας σύμφωνα με τις παραμέτρους που έγινε η κλήση
 *
 *
 * Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο GET :
 * <br> http://mmsch.teiath.gr/api/operation_shifts
 *
 *
 * Τα αποτελέσματα είναι ταξινομημένα ως προς το Όνομα του Ωραρίου Λειτουργίας
 ...
 * <code>
 *    curl -X GET http://mmsch.teiath.gr/api/operation_shifts \
 ...
 *    http.open("GET", "http://mmsch.teiath.gr/api/operation_shifts");
 ...
 * 
 * $curl = curl_init("http://mmsch.teiath.gr/api/operation_shifts");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mmsch.teiath.gr/api/operation_shifts',
 *        dataType: "json",
 ...
 * {"data":[
 *		{
 *			"operation_shift_id": 2,
 *			"operation_shift": "ΕΣΠΕΡΙΝΟ",
 *			"category_id": 1,
 *			"category": "ΣΧΟΛΙΚΕΣ ΚΑΙ ΔΙΟΙΚΗΤΙΚΕΣ ΜΟΝΑΔΕΣ"
 *		},
 *		{
 *			"operation_shift_id": 1,
 *			"operation_shift": "ΗΜΕΡΗΣΙΟ",
 *			"category_id": 1,
 *			"category": "ΣΧΟΛΙΚΕΣ ΚΑΙ ΔΙΟΙΚΗΤΙΚΕΣ ΜΟΝΑΔΕΣ"
 *		},
 *		{
 ...
 * 
 * 
 * @param mixed $operation_shift Ωράριo Λειτουργίας
 * <br>Το Όνομα ή ο Κωδικός του Ωραρίου Λειτουργίας
 ...
 *    <ul>
 *       <li>integer
 *          <br>Αριθμητική : Η αναζήτηση γίνεται με τον κωδικό του Ωραρίου Λειτουργίας
 *          <br>Η αναζήτηση στον Κωδικό γίνεται με τον Τύπο {@see SearchEnumTypes::Exact}
 *       </li>
 *       <li>string
 *          <br>Αλφαριθμητική : Η αναζήτηση γίνεται με το όνομα του Ωραρίου Λειτουργίας
 ...
 *          θα αναζητηθεί η τιμή της παραμέτρου στο Όνομα του Ωραρίου Λειτουργίας
 *          <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα του Ωραρίου Λειτουργίας γίνεται με τον Tύπο {@see SearchEnumTypes::ContainAll}
 *       </li>
 ...
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η ταξινόμηση γίνεται με το Όνομα του Ωραρίου Λειτουργίας
 ...
 * <br>Ο Τύπος Αναζήτησης με τον οποίο γίνεται η αναζήτηση στο Όνομα (<a href="#$operation_shift">$operation_shift</a>) του Ωραρίου Λειτουργίας
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα γίνεται με τον Τύπο {@see SearchEnumTypes::ContainAll}
 * <br>Αν το Όνομα έχει Αριθμητική Τιμή τότε η αναζήτηση γίνεται με τον Κωδικό του Ωραρίου Λειτουργίας με Τύπο {@see SearchEnumTypes::Exact}
 * <br>Λίστα Τύπων Αναζήτησης : {@see SearchEnumTypes}
 * <br>Η τιμή της παραμέτρου μπορεί να είναι : string
 * <ul>
 *    <li>string
 ...
 * <ul>
 *    <li>integer : <b>operation_shift_id</b> : Ο Κωδικός του Ωραρίου Λειτουργίας</li>
 *    <li>string : <b>operation_shift</b> : Το Όνομα του Ωραρίου Λειτουργίας</li>
 ...
 * <br>Το Ωράριο Λειτουργίας πρέπει να είναι αριθμητικός ή αλφαριθμητικός
 *
...
function GetOperationShifts(
    $operation_shift, $category,
...
//======================================================================================================================
        ...
        $sqlFrom = "FROM operation_shifts
                    LEFT JOIN categories ON operation_shifts.category_id = categories.category_id";
        ...
        {
            $result["data"][] = array(
                "operation_shift_id" => (int)$row["operation_shift_id"],
