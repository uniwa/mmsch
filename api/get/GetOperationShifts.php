 ...
 * <code>
 *    curl -X GET https://mm.sch.gr/api/operation_shifts \
 ...
 *    http.open("GET", "https://mm.sch.gr/api/operation_shifts");
 ...
 * 
 * $curl = curl_init("https://mm.sch.gr/api/operation_shifts");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'https://mm.sch.gr/api/operation_shifts',
 *        dataType: "json",
