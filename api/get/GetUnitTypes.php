 ...
 * <br> http://mm.sch.gr/api/unit_types
 *
 *
 ...
 * <code>
 *    curl -X GET http://mm.sch.gr/api/unit_types \
 ...
 *    http.open("GET", "http://mm.sch.gr/api/unit_types");
 ...
 * 
 * $curl = curl_init("http://mm.sch.gr/api/unit_types");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mm.sch.gr/api/unit_types',
 *        dataType: "json",
