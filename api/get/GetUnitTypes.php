 ...
 * <br> http://mmsch.teiath.gr/api/unit_types
 *
 *
 ...
 * <code>
 *    curl -X GET http://mmsch.teiath.gr/api/unit_types \
 ...
 *    http.open("GET", "http://mmsch.teiath.gr/api/unit_types");
 ...
 * 
 * $curl = curl_init("http://mmsch.teiath.gr/api/unit_types");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mmsch.teiath.gr/api/unit_types',
 *        dataType: "json",
...
function GetUnitTypes(
    $unit_type, $category, $education_level,
...
//======================================================================================================================
        ...
        $sqlFrom   = "FROM unit_types
                      LEFT JOIN categories ON unit_types.category_id = categories.category_id
                      LEFT JOIN education_levels ON unit_types.education_level_id = education_levels.education_level_id";
