...
/**
 * <b>Λεξικό : Τύποι IP Δικτυακών Στοιχείων</b>
 *
 *
 * Η συνάρτηση αυτή επιστρέφει όλους τους Τύπους IP Δικτυακών Στοιχείων σύμφωνα με τις παραμέτρους που έγινε η κλήση
 *
 *
 * Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο GET :
 * <br> https://mm.sch.gr/api/unit_network_subnet_types
 *
 *
 ...
 * <code>
 *    curl -X GET https://mm.sch.gr/api/unit_network_subnet_types \
 ...
 *    http.open("GET", "https://mm.sch.gr/api/unit_network_subnet_types");
 ...
 *  
 *
 * @param mixed $subnet_type Τύπος IP Δικτυακού Στοιχείου
 * <br>Ο Κωδικός και το Όνομα του Τύπου IP Δικτυακού Στοιχείου
 ...
 *    </li>
 *    <li>string
 *       <br>Αλφαριθμητική : Η αναζήτηση γίνεται με το Όνομα του Τυπου IP Δικτυακού Στοιχείου
 ...
 *       θα αναζητηθεί η τιμή της παραμέτρου στο Όνομα του Τυπου IP Δικτυακού Στοιχείου
 *       <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα του Τυπου IP Δικτυακού Στοιχείου γίνεται με τον Tύπο {@see SearchEnumTypes::ContainAll}
 *    </li>
 ...
 * <br>Ο αριθμός της σελίδας με τις <a href="#$pagesize">$pagesize</a> εγγραφές που βρέθηκαν σύμφωνα με τις παραμέτρους
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 ...
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η ταξινόμηση γίνεται με το Όνομα του Τυπου IP Δικτυακού Στοιχείου
 ...
 * <br>Ο Τύπος Αναζήτησης με τον οποίο γίνεται η αναζήτηση στο Όνομα (<a href="#$subnet_type">$subnet_type</a>) του Τυπου IP Δικτυακού Στοιχείου
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα γίνεται με τον Τύπο {@see SearchEnumTypes::ContainAll}
 * <br>Αν το Όνομα έχει Αριθμητική Τιμή τότε η αναζήτηση γίνεται με τον Κωδικό του Τυπου IP Δικτυακού Στοιχείου με Τύπο {@see SearchEnumTypes::Exact}
 * <br>Λίστα Τύπων Αναζήτησης : {@see SearchEnumTypes}
 * <br>Η τιμή της παραμέτρου μπορεί να είναι : string
 * <ul>
 *    <li>string
 ...
 * <ul>
 *   <li>integer : <b>unit_network_subnet_type_id</b> : Ο Κωδικός του Τυπου IP Δικτυακού Στοιχείου</li>
 *   <li>string : <b>unit_network_subnet_type</b> : Το Όνομα του Τυπου IP Δικτυακού Στοιχείου</li>
 * </ul>
 *
 * 
 * 
...
function GetUnitNetworkSubnetTypes(
    $subnet_type,
...
//==============================================================================
        ...
        $sqlSelect = "SELECT
                        ...
                        unit_network_subnet_types.subnet_type
                     ";

        $sqlFrom   = "FROM unit_network_subnet_types";
