 ...
 * <br> http://mmsch.teiath.gr/api/prefectures
 *
 *
 ...
 * <code>
 *    curl -X GET http://mmsch.teiath.gr/api/prefectures \
 ...
 *    http.open("GET", "http://mmsch.teiath.gr/api/prefectures");
 ...
 * header("Content-Type: text/html; charset=utf-8");
 * 
 * $curl = curl_init("http://mmsch.teiath.gr/api/prefectures");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mmsch.teiath.gr/api/prefectures',
 *        dataType: "json",
