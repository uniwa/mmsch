 ...
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **GET** και route_api_name = **prefectures** :
 ...
 * <ul>
 *    <li>integer
 *       <br>Αριθμητική : Η αναζήτηση γίνεται με τον Κωδικό ID της Περιφερειακής Ενότητας
 *       <br>Η αναζήτηση στον Κωδικό γίνεται με τον Τύπο {@see SearchEnumTypes::Exact}
 *    </li>
 *    <li>string
 *       <br>Αλφαριθμητική : Η αναζήτηση γίνεται με το Όνομα της Περιφερειακής Ενότητας
 ...
 *  <ul>
 *    <li>integer : <b>prefecture_id</b> : Ο Κωδικός ID της Περιφερειακής Ενότητας</li>
 *    <li>string : <b>prefecture</b> : Το Όνομα της Περιφερειακής Ενότητας</li>
 *  </ul>
