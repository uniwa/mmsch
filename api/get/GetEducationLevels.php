...
/**
 * <b>Λεξικό : Επίπεδα Εκπαίδευσης</b>
 *
 *
 *
 * Η συνάρτηση αυτή επιστρέφει όλα τα Επίπεδα Εκπαίδευσης σύμφωνα με τις παραμέτρους που έγινε η κλήση
 *
 *
 ...
 *
 *
 * Τα αποτελέσματα είναι ταξινομημένα ως προς το Όνομα του Επιπέδου Εκπαίδευσης
 ...
 * <code>
 *    curl -X GET https://mm.sch.gr/api/education_levels \
 ...
 *    http.open("GET", "https://mm.sch.gr/api/education_levels");
 ...
 * header("Content-Type: text/html; charset=utf-8");
 *
 * $curl = curl_init("https://mm.sch.gr/api/education_levels");
 *
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'https://mm.sch.gr/api/education_levels',
 *        dataType: "json",
 ...
 *			"education_level": "ΜΕΤΑΔΕΥΤΕΡΟΒΑΘΜΙΑ"
 *		},
 *		{
 ...
 *       θα αναζητηθεί η τιμή της παραμέτρου στο Όνομα του Επιπέδου Εκπαίδευσης
 *       <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα του Επιπέδου Εκπαίδευσης γίνεται με τον Tύπο {@see SearchEnumTypes::ContainAll}
 *    </li>
 ...
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η ταξινόμηση γίνεται με το Όνομα του Επιπέδου Εκπαίδευσης
 ...
 * <br>Ο Τύπος Αναζήτησης με τον οποίο γίνεται η αναζήτηση στο Όνομα (<a href="#$education_level">$education_level</a>) του Επιπέδου Εκπαίδευσης
 * <br>Η παράμετρος δεν είναι υποχρεωτική
 * <br>Αν η παράμετρος δεν έχει τιμή τότε η αναζήτηση στο Όνομα γίνεται με τον Τύπο {@see SearchEnumTypes::ContainAll}
 * <br>Αν το Όνομα έχει Αριθμητική Τιμή τότε η αναζήτηση γίνεται με τον Κωδικό του Επιπέδου Εκπαίδευσης με Τύπο {@see SearchEnumTypes::Exact}
 * <br>Λίστα Τύπων Αναζήτησης : {@see SearchEnumTypes}
 * <br>Η τιμή της παραμέτρου μπορεί να είναι : string
 * <ul>
 *    <li>string
 ...
 * <br>Το Επίπεδο Εκπαίδευσης πρέπει να είναι αριθμητική ή αλφαριθμητική
 *
...
function GetEducationLevels( $education_level,
...
//data results==================================================================       
        ...
        foreach ($results as $row)
        {
            ...
            $result["data"][] = array(
                                            "education_level_id" => $row->getEducationLevelId(),
                                            "education_level"    => $row->getName()                                        
                                     );
            $count++;
        }
        $result["count"] = $count;
