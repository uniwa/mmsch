...
/** 
 * **ΛΕΞΙΚΟ : Επίπεδα Εκπαίδευσης**
 * 
 * Η συνάρτηση αυτή επιστρέφει Επίπεδα Εκπαίδευσης σύμφωνα με τις παραμέτρους που έγινε η κλήση.
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **GET** και route_api_name = **education_levels** :
 ...
 *  "status": 200,
 *  "message": "[GET][education_levels]:success"
 * }
 * </code>
 *
 * ***Πίνακας Δεδομένων***
 ...
 * 
 * 
 * @param mixed $education_level Επίπεδo Εκπαίδευσης
 * <br>
 * <br>Το Όνομα ή ο Κωδικός ID του Επίπεδoυ Εκπαίδευσης
 * <br>Η τιμή της παραμέτρου μπορεί να είναι : mixed{integer|string|array[integer|string]}
 * <ul>
 *    <li>integer
 *       <br>Αριθμητική : Η αναζήτηση γίνεται με τον Κωδικό ID του Επίπεδoυ Εκπαίδευσης
 *       <br>Η αναζήτηση στον Κωδικό γίνεται με τον Τύπο {@see SearchEnumTypes::Exact}
 *    </li>
 *    <li>string
 *       <br>Αλφαριθμητική : Η αναζήτηση γίνεται με το Όνομα του Επίπεδoυ Εκπαίδευσης
 ...
 *  <ul>
 *    <li>integer : <b>education_level_id</b> : Ο Κωδικός ID του Επίπεδου Εκπαίδευσης</li>
 *    <li>string : <b>education_level</b> : Το Όνομα του Επίπεδου Εκπαίδευσης</li>
 *  </ul>
