 ...
 * <br> http://mmsch.teiath.gr/api/edu_admins
 *
 *
 ...
 * <code>
 *    curl -X GET http://mmsch.teiath.gr/api/edu_admins \
 ...
 *    http.open("GET", "http://mmsch.teiath.gr/api/edu_admins");
 ...
 * 
 * $curl = curl_init("http://mmsch.teiath.gr/api/edu_admins");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mmsch.teiath.gr/api/edu_admins',
 *        dataType: "json",
