...
/**
* **ΛΕΞΙΚΟ : Ειδικοί Τύποι Μονάδων**
 * 
 * Η συνάρτηση αυτή επιστρέφει Ειδικούς Τύπους Μονάδων σύμφωνα με τις παραμέτρους που έγινε η κλήση.
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **GET** και route_api_name = **special_types** :
 ...
 *  "status": 200,
 *  "message": "[GET][special_types]:success"
 * }
 * </code>
 *
 * ***Πίνακας Δεδομένων***
 ...
 * 
 * 
 * @param mixed $special_type Ειδικός Τύπος Μονάδων
 * <br>
 * <br>Το Όνομα ή ο Κωδικός ID του Ειδικού Τύπου Μονάδων
 * <br>Η τιμή της παραμέτρου μπορεί να είναι : mixed{integer|string|array[integer|string]}
 * <ul>
 *    <li>integer
 *       <br>Αριθμητική : Η αναζήτηση γίνεται με τον Κωδικό ID του Ειδικού Τύπου Μονάδων
 *       <br>Η αναζήτηση στον Κωδικό γίνεται με τον Τύπο {@see SearchEnumTypes::Exact}
 *    </li>
 *    <li>string
 *       <br>Αλφαριθμητική : Η αναζήτηση γίνεται με το Όνομα του Ειδικού Τύπου Μονάδων
 ...
 *  <ul>
 *    <li>integer : <b>special_type_id</b> : Ο Κωδικός ID του Ειδικού Τύπου Μονάδων</li>
 *    <li>string : <b>special_type</b> : Το Όνομα του Ειδικού Τύπου Μονάδων</li>
