 ...
 * <br> http://mmsch.teiath.gr/api/special_types
 *
 *
 ...
 * <code>
 *    curl -X GET http://mmsch.teiath.gr/api/special_types \
 ...
 *    http.open("GET", "http://mmsch.teiath.gr/api/special_types");
 ...
 * 
 * $curl = curl_init("http://mmsch.teiath.gr/api/special_types");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mmsch.teiath.gr/api/special_types',
 *        dataType: "json",
...
//======================================================================================================================
        ...
        $sqlFrom = "FROM special_types
                    LEFT JOIN categories ON special_types.category_id = categories.category_id";
        ...
        {
            $result["data"][] = array(
                "special_type_id" => (int)$row["special_type_id"],
