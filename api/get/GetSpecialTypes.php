 ...
 * <br> http://mm.sch.gr/api/special_types
 *
 *
 ...
 * <code>
 *    curl -X GET http://mm.sch.gr/api/special_types \
 ...
 *    http.open("GET", "http://mm.sch.gr/api/special_types");
 ...
 * 
 * $curl = curl_init("http://mm.sch.gr/api/special_types");
 * 
 ...
 *    $.ajax({
 *        type: 'GET',
 *        url: 'http://mm.sch.gr/api/special_types',
 *        dataType: "json",
