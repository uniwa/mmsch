...
//##########################################################################################################################
    ...
    const DuplicatedUnitDnsUniqueValue = 'Ενημερώστε τον διαχειριστή! Βρέθηκε διπλοεγγραφή primary key UnitDns';
 
    //delete
        const DuplicateDelUnitDnsValue = 'Ενημερώστε τον διαχειριστή! Βρέθηκε διπλοεγγραφή με ίδιο Κωδικό DNS Μονάδας'; 
        const NotFoundDelUnitDnsValue = 'Δεν βρέθηκε η εγγραφή προς διαγραφή.';
