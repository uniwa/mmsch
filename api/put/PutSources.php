...
/**
 * **ΛΕΞΙΚΟ : Ενημέρωση Πρωτογενής Πηγής Μονάδων**
 *
 * Η συνάρτηση ενημερώνει Πρωτογενής Πηγή Μονάδων σύμφωνα με τις παραμέτρους που έγινε η κλήση.
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **PUT** και route_api_name = **sources** :
 ...
 * <code>
 * {
 * "controller": "PutSources",
 * "function": "sources",
 * "method": "PUT",
 * "parameters": { "source_id": ``,"name": ``,"visible": `` },
 * "source_id": ``,
 * "status": 200,
 * "message": "[PUT][sources]:success"
 * }
 * </code>
 * 
 * 
 ...
 *
 * @throws InvalidSourceIDType {@see ExceptionMessages::InvalidSourceIDType}
 * <br>{@see ExceptionCodes::InvalidSourceIDType}
 *
 * @throws InvalidSourceValue {@see ExceptionMessages::InvalidSourceValue}
 * <br>{@see ExceptionCodes::InvalidSourceValue}
 *
