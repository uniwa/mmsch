...
/**
 * **ΛΕΞΙΚΟ : Ενημέρωση Φορέα Υλοποίησης**
 *
 * Η συνάρτηση ενημερώνει Φορέα Υλοποίησης σύμφωνα με τις παραμέτρους που έγινε η κλήση.
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **PUT** και route_api_name = **implementation_entities** :
 ...
 * <code>
 * {
 * "controller": "PutImplementationEntities",
 * "function": "implementation_entities",
 * "method": "PUT",
 * "parameters": { "implementation_entity_id": ``,"name": ``,"initials": ``,"street_address": ``,
 *                 "postal_code": ``,"email": ``,"phone_number": ``,"domain": ``,"url": `` },
 * "implementation_entity_id": ``,
 * "status": 200,
 * "message": "[PUT][implementation_entities]:success"
 * }
 * </code>
 * 
 * 
 ...
 * <br>integer : <b>implementation_entity_id</b> : Ο Κωδικός ID του Φορέα Υλοποίησης που ενημερώθηκε
 ...
 * <br>{@see ExceptionCodes::InvalidImplementationEntityValue}
 *
