...
/** 
 * <b>Ενημέρωση Τηλεπικοινωνιακών Κυκλωμάτων</b>
 * 
 * 
 * Η συνάρτηση αυτή ενημερώνει Τηλεπικοινωνιακά Κυκλώματα σύμφωνα με τις παραμέτρους που έγινε η κλήση
 *
 *
 ...
 * <code>
 * curl -X PUT https://mm.sch.gr/api/circuits \
 ...
 *    http.open("PUT", "https://mm.sch.gr/api/circuits");
 ...
 *
 *
 * @param integer $circuit_id <b><i>Κωδικός Τηλεπικοινωνιακού Κυκλώματος</i></b>
 * <br>Ο Κωδικός του Τηλεπικοινωνιακού Κυκλώματος
 * <br>Η παράμετρος είναι υποχρεωτική
 * <br>Τηλεπικοινωνιακά Κυκλώματα : {@see GetCircuits}
...
function PutCircuits(
    $circuit_id, $mm_id, $circuit_type_id, $phone_number, $status, $activated_date, $updated_date, $deactivated_date,
...
//======================================================================================================================
        ...
        if ( $filters["phone_number"] )
        {
            $sql = "SELECT
                    circuit_id,
                    phone_number
                FROM circuits WHERE ".$filters["phone_number"]." AND NOT ".$filters["circuit_id"];
...
//======================================================================================================================
        ...
        $sqlWhere = " WHERE ". $filters["circuit_id"];

        unset($filters["circuit_id"]);

        $sql = "UPDATE circuits SET " . implode(", ", $filters) .$sqlWhere;
        //echo "<br><br>".$sql."<br><br>";
        $array_sql[] = trim( preg_replace('/\s\s+/', ' ', $sql));
