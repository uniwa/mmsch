...
/** 
 * <b>Ενημέρωση Συσχέτισης Διασύνδεσης και Υποδικτύου Μονάδας</b>
 * 
 * 
 ...
 * <br> https://mm.sch.gr/api/connection_unit_network_subnets <br><br>
 *
...
//======================================================================================================================
        ...
        $sqlWhere = " WHERE ". $filters["connection_unit_network_subnet_id"];

        unset($filters["connection_unit_network_subnet_id"]);

        $sql = "UPDATE connection_unit_network_subnets SET " . implode(", ", $filters) .$sqlWhere;
        //echo "<br><br>".$sql."<br><br>";
        $array_sql[] = trim( preg_replace('/\s\s+/', ' ', $sql));
