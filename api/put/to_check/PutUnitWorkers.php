...
function PutUnitWorkers( $unit_worker_id, $mm_id, $worker_registry_no, $worker_position )
{
    global $db;
    global $Options;
...
//==============================================================================
            ...
            {
                $filter = array( new DFC(UnitsExt::FIELD_MM_ID, $mm_id, DFC::EXACT) );
...
//==============================================================================
            ...
            {
                $filter = array( new DFC(WorkersExt::FIELD_REGISTRY_NO, $worker_registry_no, DFC::EXACT) );
...
//==============================================================================
            ...
            {
                $filter = array( new DFC(WorkerPositionsExt::FIELD_WORKER_POSITION_ID, $worker_position, DFC::EXACT) );
                $oWorkerPosition = $oWorkerPosition->findByFilter($db, $filter, true);  
            }
            else if ($worker_position)
            {
                $filter = array( new DFC(WorkerPositionsExt::FIELD_NAME, $worker_position, DFC::EXACT) );
                $oWorkerPosition = $oWorkerPosition->findByFilter($db, $filter, true);
            }
