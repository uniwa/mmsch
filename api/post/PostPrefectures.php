...
/**
 * **ΛΕΞΙΚΟ : Καταχώρηση Περιφερειακής Ενότητας**
 *
 * Η συνάρτηση καταχωρεί Περιφερειακή Ενότητα σύμφωνα με τις παραμέτρους που έγινε η κλήση.
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **POST** και route_api_name = **prefectures** :
 ...
 * <code>
 * {
 * "controller": "PostPrefectures",
 * "function": "prefectures",
 * "method": "POST",
 * "parameters": { "name": `` },
 * "prefecture_id": ``,
 * "status": 200,
 * "message": "[POST][prefectures]:success"
 * }
 * </code>
 * 
 * 
 ...
 * <br>integer : <b>prefecture_id</b> : Ο Κωδικός ID της Περιφερειακής Ενότητας που δημιουργήθηκε
