 ...
 *
 * Η συνάρτηση καταχωρεί Κατηγορία σύμφωνα με τις παραμέτρους που έγινε η κλήση.
 * <br>Η κλήση μπορεί να γίνει μέσω της παρακάτω διεύθυνσης με τη μέθοδο **POST** και route_api_name = **categories** :
 ...
 * "category_id": ``,
 * "status": 200,
 * "message": "[POST][categories]:success"
 * }
 * </code>
 *
 * 
 ...
 * <br>
 * <br>Το Όνομα της Κατηγορίας της Μονάδας
 ...
 * <br>integer : <b>category_id</b> : Ο Κωδικός ID της Κατηγορίας Μονάδας που δημιουργήθηκε
