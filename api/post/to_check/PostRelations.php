 ...
 * <br> http://mmsch.teiath.gr/api/relations <br><br>
 *
 * 
 * 
 * Παράδειγμα κλήσης της μεθόδου με <b>cURL</b> (console) :
 * <code>
 * curl -X POST http://mmsch.teiath.gr/api/relations \
 ...
 *    http.open("POST", "http://mmsch.teiath.gr/api/relations");
 ...
 * );
 * 
 * $curl = curl_init("http://mmsch.teiath.gr/api/relations");
 * 
 ...
 *    $.ajax({
 *        type: 'POST',
 *        url: 'http://mmsch.teiath.gr/api/relations',
 *        dataType: "json",
 *        data: {
 *            "host_mm_id" => "value", 
 *            "guest_mm_id" => "value", 
