...
//======================================================================================================================
        ...
        if ( Validator::Exists($table_column_name, $params) )
        {
            ...
            elseif ( Validator::isID($param) )
            {
                ...
                if ( $stmt->rowCount() == 0 )
                {
                    throw new Exception(ExceptionMessages::InvalidCircuitTypeValue." : ".$circuit_id, ExceptionCodes::InvalidCircuitTypeValue);
                }
...
//==============================================================================================================
        ...
        $sql = "SELECT
                    circuit_id
                FROM circuits WHERE ".$filters["circuit_type_id"];
        ...
        if ( $stmt->rowCount() > 0 )
        {
            throw new Exception(ExceptionMessages::UsedCircuitTypeByCircuits, ExceptionCodes::UsedCircuitTypeByCircuits);
        }
...
//==============================================================================================================
        ...
        $sql = "DELETE FROM circuit_types WHERE " . implode(", ", $filters);
        //echo "<br><br>".$sql."<br><br>";
        $array_sql[] = trim( preg_replace('/\s\s+/', ' ', $sql));
