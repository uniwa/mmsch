...
require_once 'sync/sync_survey_dides_data.php';
require_once 'sync/sync_survey_dides.php';

//==============================================================================

$data    = json_decode( sync_survey_dides_data() );
...
$data    = json_decode( sync_survey_dides() );
$message = $data->message;
