...
class Workers extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	...
	/**
	 * set value for worker_specialization_id 
	 *
	...
	/**
	 * get value for worker_specialization_id 
	 *
	 * type:INT,size:10,default:null,index,nullable
	 *
	 * @return mixed
	...
	/**
	 * Fetch UnitWorkers's which this Workers references.
	 * `workers`.`worker_id` -> `unit_workers`.`worker_id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	 * @return UnitWorkers[]
	...
	public function fetchUnitWorkersCollection(PDO $db, $sort=null) {
		$filter=array(UnitWorkers::FIELD_WORKER_ID=>$this->getWorkerId());
