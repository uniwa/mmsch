...
require_once('classes/models/LegalCharacters.class.php');

class LegalCharactersExt extends LegalCharacters
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getLegalCharacterId()] = $obj->getName(); 
            $this->objsArray[$obj->getLegalCharacterId()] = $obj; 
        }
    }
