...
require_once('classes/models/UnitTypes.class.php');

class UnitTypesExt extends UnitTypes
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getUnitTypeId()] = $obj->getName(); 
            $this->objsArray[$obj->getUnitTypeId()] = $obj; 
        }
    }
