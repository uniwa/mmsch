...
require_once('classes/models/IpMasks.class.php');

class IpMasksExt extends IpMasks
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getIpMaskId()] = $obj->getName(); 
            $this->objsArray[$obj->getIpMaskId()] = $obj; 
        }
    }
