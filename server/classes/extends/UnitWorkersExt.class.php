...
require_once('classes/models/UnitWorkers.class.php');

class UnitWorkersExt extends UnitWorkers
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getUnitWorkerId()] = $obj->getUnitWorkerId(); 
            $this->objsArray[$obj->getUnitWorkerId()] = $obj; 
        }
    }
    ...
    public static function getAllByUnit(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getMmId()][$obj->getUnitWorkerId()] = $obj->getUnitWorkerId(); 
            $this->objsArray[$obj->getMmId()][$obj->getUnitWorkerId()] = $obj; 
        }
    }
