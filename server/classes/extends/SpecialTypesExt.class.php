...
require_once('classes/models/SpecialTypes.class.php');

class SpecialTypesExt extends SpecialTypes
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getSpecialTypeId()] = $obj->getName(); 
            $this->objsArray[$obj->getSpecialTypeId()] = $obj; 
        }
    }
