...
require_once('classes/models/Levels.class.php');

class LevelsExt extends Levels
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getLevelId()] = $obj->getName(); 
            $this->objsArray[$obj->getLevelId()] = $obj; 
        }
    }
    ...
    public function getAllByUnit(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getMmId()][$obj->getLevelId()] = $obj->getName(); 
            $this->objsArray[$obj->getMmId()][$obj->getLevelId()] = $obj; 
        }
    }
