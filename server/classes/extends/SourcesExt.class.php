...
require_once('classes/models/Sources.class.php');

class SourcesExt extends Sources
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getSourceId()] = $obj->getName(); 
            $this->objsArray[$obj->getSourceId()] = $obj; 
        }
    }
