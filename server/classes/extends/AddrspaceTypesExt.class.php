...
require_once('classes/models/AddrspaceTypes.class.php');

class AddrspaceTypesExt extends AddrspaceTypes
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getAddrspaceTypeId()] = $obj->getName(); 
            $this->objsArray[$obj->getAddrspaceTypeId()] = $obj; 
        }
    }
