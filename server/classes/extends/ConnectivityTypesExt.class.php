...
require_once('classes/models/ConnectivityTypes.class.php');

class ConnectivityTypesExt extends ConnectivityTypes
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getConnectivityTypeId()] = $obj->getName(); 
            $this->objsArray[$obj->getConnectivityTypeId()] = $obj; 
        }
    }
