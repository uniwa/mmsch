...
require_once('classes/models/UnitIpDns.class.php');

class UnitIpDnsExt extends UnitIpDns
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getIpDnsId()] = $obj->getIpDnsId(); 
            $this->objsArray[$obj->getIpDnsId()] = $obj; 
        }
    }
    ...
    public function getAllByUnit(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getMmId()][$obj->getIpDnsId()] = $obj->getIpDnsId(); 
            $this->objsArray[$obj->getMmId()][$obj->getIpDnsId()] = $obj; 
        }
    }
