...
require_once('classes/models/Relations.class.php');

class RelationsExt extends Relations
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getRelationId()] = $obj->getRelationId(); 
            $this->objsArray[$obj->getRelationId()] = $obj; 
        }
    }
    
    public function getAllByHostUnit(PDO $db, $filter, $and=true, $sort=null) 
    { 
        $this->rowsArray = array();
        $this->objsArray = array();
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getHostMmId()][$obj->getRelationId()] = $obj->getRelationId(); 
            $this->objsArray[$obj->getHostMmId()][$obj->getRelationId()] = $obj; 
        }
    }
    
    public function getAllByGuestUnit(PDO $db, $filter, $and=true, $sort=null) 
    {
        $this->rowsArray = array();
        $this->objsArray = array();
        ...
        foreach($objs as $obj)
        {
           $this->rowsArray[$obj->getGuestMmId()][$obj->getRelationId()] = $obj->getRelationId(); 
           $this->objsArray[$obj->getGuestMmId()][$obj->getRelationId()] = $obj; 
        }
    }
    ...
    public function findByFilterAsCount(PDO $db, $filter, $and=true) 
    {
