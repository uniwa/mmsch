...
require_once('classes/models/Cpes.class.php');

class CpesExt extends Cpes
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getCpeId()] = $obj->getName(); 
            $this->objsArray[$obj->getCpeId()] = $obj; 
        }
    }
    ...
    public function getAllByUnit(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getMmId()][$obj->getCpeId()] = $obj->getName(); 
            $this->objsArray[$obj->getMmId()][$obj->getCpeId()] = $obj; 
        }
    }
