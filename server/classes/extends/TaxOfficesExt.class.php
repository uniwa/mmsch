...
require_once('classes/models/TaxOffices.class.php');

class TaxOfficesExt extends TaxOffices
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getTaxOfficeId()] = $obj->getName(); 
            $this->objsArray[$obj->getTaxOfficeId()] = $obj; 
        }
    }
