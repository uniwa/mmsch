...
require_once('classes/models/OrientationTypes.class.php');

class OrientationTypesExt extends OrientationTypes
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getOrientationTypeId()] = $obj->getName(); 
            $this->objsArray[$obj->getOrientationTypeId()] = $obj; 
        }
    }
