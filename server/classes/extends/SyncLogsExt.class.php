...
require_once('classes/models/SyncLogs.class.php');

class SyncLogsExt extends SyncLogs
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getSyncLogId()] = $obj->getName(); 
            $this->objsArray[$obj->getSyncLogId()] = $obj; 
        }
    }
