...
require_once('classes/models/OperationShifts.class.php');

class OperationShiftsExt extends OperationShifts
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getOperationShiftId()] = $obj->getName(); 
            $this->objsArray[$obj->getOperationShiftId()] = $obj; 
        }
    }
