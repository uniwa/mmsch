...
require_once('classes/models/ImplementationEntities.class.php');

class ImplementationEntitiesExt extends ImplementationEntities
{
    private $rowsArray;
    private $objsArray;
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getImplementationEntityId()] = $obj->getName(); 
            $this->objsArray[$obj->getImplementationEntityId()] = $obj; 
        }
    }
