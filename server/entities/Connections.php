 ...
 * Connections
 *
 * @ORM\Table(name="connections", indexes={@ORM\Index(name="cpes_idx", columns={"cpe_id"}), @ORM\Index(name="ldap_idx", columns={"ldap_id"}), @ORM\Index(name="units_idx", columns={"mm_id"}), @ORM\Index(name="circuits_idx", columns={"circuit_id"})})
 * @ORM\Entity
 */
class Connections
{
